#source:https://github.com/chengtan9907/SimVPv2/blob/fde39a2494e435773ef5fda486b7a9c6582063ba/modules/phydnet_modules.py
import torch
...
class PhyD_EncoderRNN(torch.nn.Module):
    ...
    def forward(self, input, first_timestep=False, decoding=False):
        ...
        output_image = self.decoder_D(concat )  # DHAN modified
