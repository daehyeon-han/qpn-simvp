...
original source: https://github.com/vincent-leguen/PhyDNet

code from https://github.com/chengtan9907/SimVPv2/blob/fde39a2494e435773ef5fda486b7a9c6582063ba/models/phydnet_model.py#L6 
"""
import random
import torch
...
class PhyDNet_Model(nn.Module):
    def __init__(self, pre_seq_length=12, aft_seq_length=12, device='cuda', **kwargs):
        super(PhyDNet_Model, self).__init__()
        self.pre_seq_length = pre_seq_length
        self.aft_seq_length = aft_seq_length

        self.phycell = PhyCell(input_shape=(76,76), input_dim=64, F_hidden_dims=[49], n_layers=1, kernel_size=(7,7), device=device) 
        self.convcell = PhyD_ConvLSTM(input_shape=(76,76), input_dim=64, hidden_dims=[128,128,64], n_layers=3, kernel_size=(3,3), device=device)   
